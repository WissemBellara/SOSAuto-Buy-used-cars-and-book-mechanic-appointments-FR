    ...
    class dbConnect
    {
        ...
        { 
            try {
               ...
               //     echo "You are now connected to SosAuto";
               //     $toy_data=["Nom"=>"Wissem",
               //     "Prenom"=>"Wissem",
               //     "Email"=>"Wissembellara00@icloud.com",
               //     "Tel"=>"+21627090678",
               //     "Objet"=>"Reparation de Ibiza",
              
               //     
               //     $sqlRequest="insert into contact(Nom,Prenom,Email,Tel,Objet,Message) values(:Nom,:Prenom,:Email,:Tel,:Objet,:Message)";
               //     $stmt=$this->dbCon->prepare($sqlRequest);
               //     $stmt->execute($toy_data);
               //     echo "the Contact Wissem has been successufly added";
        ...
        //setters and getters
        public function setDatabaseName($databaseName='sosauto')
        {
